...
// Mensajes de alerta en el registro
const error_message = ref("");
const success_message = ref("");

const button_label = ref("Registrarse");
...
const onRegister = async () => {
    ...
    if (password.value !== confirm_password.value) {
        error_message.value = "Las contraseñas ingresadas no coinciden";
        resetMessage();
        return;
    }
    ...
    <article class="max-w-screen-sm mx-auto mt-20">
        ...
        <section class="px-4 py-10">
            ...
            >
                ...
                <MainButton :button_label="button_label" @auth="onRegister" />
            </form>
